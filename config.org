...
#+begin_src emacs-lisp
(use-package telega)
;This is to enable notifications in the d-bus
(telega-notifications-mode 1)
(add-hook 'telega-load-hook 'telega-notifications-mode)
;this is to enable a global minor mode to display telega status in the modeline.
